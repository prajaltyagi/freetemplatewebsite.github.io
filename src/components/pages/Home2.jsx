...
<header class="py-1 border-bottom ">
  <div class="container-xxl bd-gutter pt-md-1 pb-md-2 ">
      <div class="row">
        ...
        <p style={styles13}><Link to="/Home2" style={styles14}>2</Link></p>
              ...
              <div class="row row-cols-1  row-cols-md-3 g-3" >
                <div class="col">
                  <div class="card shadow-sm" >
                    <img src="/images/one.jpg" width='100px' height='380px' class="bd-placeholder-img card-img-top"/>
                    <div class="card-body" >
                      <p class="card-text " style={styles5}><span style={styles2}> Rehabilitation Yoga </span> Template</p><hr/>
                      <div class="d-flex" style={styles11}>
                      <Link to='https://freewebsitetemplates.com/preview/rehabilitation-yoga/index.html' target='
                      _blank'><img src="icons/viewIcon.svg" width="30px"/></Link> 
                      <a href='/files/first.zip' download='tempate.pdf'><img src="icons/downloadIcon.svg" width="30px"/></a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col">
                    <div class="card shadow-sm">
                      <img src="/images/second.jpg" width='100px' height='380px' class="bd-placeholder-img card-img-top"/>
                      <div class="card-body" >
                      ...
                      _blank'><img src="icons/viewIcon.svg" width="30px"/></Link> 
                      <a href='/files/second.zip' download='tempate.pdf'><img src="icons/downloadIcon.svg" width="30px"/></a>
                      </div>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card shadow-sm">
                      <img src="/images/third.jpg" width='100px' height='380px' class="bd-placeholder-img card-img-top"/>
                      <div class="card-body" >
                        <p class="card-text " style={styles5}><span style={styles2}> Running Webiste </span> Template</p><hr/>
                        <div class="d-flex" style={styles11}>
                      <Link to='https://freewebsitetemplates.com/preview/running/index.html' target='
                      _blank'><img src="icons/viewIcon.svg" width="30px"/></Link> 
                      <a href='/files/third.zip' download='tempate.pdf'><img src="icons/downloadIcon.svg" width="30px"/></a>
                      </div>
                      </div>
                    </div>
                  </div>
