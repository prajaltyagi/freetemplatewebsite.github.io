...
<header class="py-1 border-bottom ">
  <div class="container-xxl bd-gutter pt-md-1 pb-md-2 ">
      <div class="row">
        ...
        <p style={styles13}><Link to="/Home" style={styles14}>1</Link></p>
              ...
              <div class="row row-cols-1  row-cols-md-3 g-3" >
                <div class="col">
                  <div class="card shadow-sm" >
                    <img src="/images/ten.jpg" width='100px' height='380px' class="bd-placeholder-img card-img-top"/>
                    <div class="card-body" >
                      <p class="card-text " style={styles5}><span style={styles2}> Rehabilitation Yoga </span> Template</p><hr/>
                      <div class="d-flex" style={styles11}>
                      <Link to='https://freewebsitetemplates.com/preview/summercamp/index.html' target='
                      _blank'><img src="icons/viewIcon.svg" width="30px"/></Link> 
                      <a href='/files/ten.zip' download='tempate.pdf'><img src="icons/downloadIcon.svg" width="30px"/></a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col">
                    <div class="card shadow-sm">
                      <img src="/images/eleven.jpg" width='100px' height='380px' class="bd-placeholder-img card-img-top"/>
                      <div class="card-body" >
                        <p class="card-text " style={styles5}><span style={styles2}> Space Science </span> Template</p><hr/>
                        <div class="d-flex" style={styles11}>
                      <Link to='https://freewebsitetemplates.com/preview/woodworkingwebsitetemplate/index.html' target='
                      _blank'><img src="icons/viewIcon.svg" width="30px"/></Link> 
                      <a href='/files/eleven.zip' download='tempate.pdf'><img src="icons/downloadIcon.svg" width="30px"/></a>
                      </div>
                      </div>
                    </div>
                  </div>
                  <div class="col">
                    <div class="card shadow-sm">
                      <img src="/images/twelve.jpg" width='100px' height='380px' class="bd-placeholder-img card-img-top"/>
                      <div class="card-body" >
                        <p class="card-text " style={styles5}><span style={styles2}> Running Webiste </span> Template</p><hr/>
                        <div class="d-flex" style={styles11}>
                      <Link to='https://freewebsitetemplates.com/preview/herdesignswebtemplate/index.html' target='
                      _blank'><img src="icons/viewIcon.svg" width="30px"/></Link> 
                      <a href='/files/twelve.zip' download='tempate.pdf'><img src="icons/downloadIcon.svg" width="30px"/></a>
                      </div>
                      </div>
                    </div>
                  </div>
